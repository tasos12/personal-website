...
export default function Experience() {
    const timelineTitleStyle = { fontWeight: 700, fontSize: '3rem', color: 'rgb(120, 200, 255)' };
    ...
    const timelineConnector = { width: '10px', borderRadius: '10px' };
                ...
                <TimelineItem>
                    ...
                    <TimelineContent>
                        ...
                        <Typography sx={timelineCompanyStyle}>
                            <LocationOnIcon sx={{ color: "white" }} /> Centre
                            for Research & Technology HELLAS (CERTH)
                        </Typography>
                ...
                <TimelineItem>
                    ...
                    <TimelineContent>
                        ...
                        <Typography sx={timelineCompanyStyle}>
                            ...
                            University of Macedonia Robotics Academy{" "}
                        </Typography>
                    </TimelineContent>
                </TimelineItem>
            </Timeline>
